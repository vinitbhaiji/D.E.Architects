    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 mx-auto contents ">
                ...
                <div class="col-lg-9">
                    <form id="contact_form" name="contact_form" method="post" enctype="multipart/form-data" action="{{route('teamUpdate',['id'=>$team->id])}}">
                        @csrf
                        @method('PUT')
                        <div class="mb-9 row">
                            <div class="col">
                                <label for="name">Team Member Name</label>
                                <input type="text" required maxlength="50" class="form-control" id="name" name="name" value="{{$team->name}}">
                            </div>
                        </div>
                        <div class="mb-9 mt-2">
                        ...
                        <div class="mb-9 mt-2">
                            ...
                            <input class="form-control" type="file" id="formFile" name="image" value="{{$team->image}}">
                        </div>
